...
def make_pipeline():
    ...
    grosshort=Fundamentals.gross_profit.latest
    redep=Fundamentals.dividend_per_share_earnings_reports.latest
    crec=Fundamentals.research_and_development.latest
    ...
    grosshort_winsorized=grosshort.winsorize(min_percentile=0.05, max_percentile=0.95)
    redep_winsorized=redep.winsorize(min_percentile=0.05, max_percentile=0.95)
    crec_winsorized=crec.winsorize(min_percentile=0.05, max_percentile=0.95)
    ...
    combined_factor = (
        ...
        crec_winsorized+
        grosshort_winsorized.zscore() + redep_winsorized.zscore()
    )
